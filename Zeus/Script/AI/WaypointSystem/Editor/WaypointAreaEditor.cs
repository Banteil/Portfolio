...
namespace Zeus
{
    ...
    [InitializeOnLoad]
    public class zWaypointAreaEditor : Editor
    {
...
#if ZEUS_AI_TEMPLATE
        [MenuItem("GameObject/Zeus/FSM AI/New Waypoint Area", false, -100)]
        [MenuItem("Zeus/FSM AI/Components/New Waypoint Area")]
...
#endif
        [MenuItem("Zeus/Melee Combat/Components/New Waypoint Area")]
