...
namespace Zeus
{
    ...
    public static class ZeusExtensions
    {
        ...
        public static List<T> ZToList<T>(this T[] array)
        {
        ...
        public static List<T> ZCopy<T>(this List<T> list)
        {
        ...
        public static T[] ZToArray<T>(this List<T> list)
        {
...
////일시정지된 Timescale에 의존하지 않는 함수를 만드는데 사용
