...
public class SlidePPTSettingPanel : MonoBehaviour
{
    GameObject curriculumItem;

    public Transform curriculumContent;
    public GameObject slideFileControlPanel;
    [HideInInspector]
    ...
    {
        SlideFileControl listScript = slideFileControlPanel.GetComponent<SlideFileControl>();
        ...
        slideFileControlPanel.SetActive(true);
    }
